...
namespace Trench.User.ArchitectureTests.Layers;
...
public class LayerTests : BaseTest
{
    ...
    [Fact]
    public void ApplicationLayer_ShouldNotHaveDependencyOn_StorageLayer()
    {
        var result = Types.InAssembly(ApplicationAssembly)
            .Should()
            .NotHaveDependencyOn(StorageAssembly.GetName().Name)
            .GetResult();
